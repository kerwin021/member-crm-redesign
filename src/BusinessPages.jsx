...
const domainConfigs = {
  ...
  "domain-config": {
    ...
    stats: [["配置项", "210", "今日变更 6 项"], ["组织与权限", "346", "待审批 9 项"], ["开放应用", "18", "启用 15 个"], ["运行异常", "2", "短信签名与回调待处理"]],
    ...
    tasks: [["会员等级日终计算", "每日 02:00", "正常", "100%"], ["新员工权限开通", "18 位员工", "待审批", "44.4%"], ["订单回调 Webhook", "今日回调 12 万次", "正常", "99.95%"], ["短信模板审核同步", "每 30 分钟", "异常", "62.0%"], ["旧版积分接口迁移", "截止 06-30", "执行中", "72.0%"]],
  },
};
